...
public interface BaseAIStrategyCentralNervous {
    ...
    default void vsInvoke(ZjhStrategyEntity zse,InvokeExact iexact,ZjhStrategyInfoDTO out){
        ...
        String Cx38=zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL34,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"C22":null;
        String Cx39=zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL34,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"C26":null;
    ...
    default void addbetInvoke(ZjhStrategyEntity zse,InvokeExact iexact,ZjhStrategyInfoDTO out){
        ...
        String EVx34=zse.getPableCount()==2&&zse.getIsRlook()&&!zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL34,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV7":null;
        String EVx35=zse.getPableCount()==2&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL23,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV9":null;
        String EVx36=zse.getPableCount()==2&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL4,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV10":null;
        String EVx37=zse.getPableCount()==2&&zse.getIsRlook()&&!zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL34,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV12":null;
        String EVx38=zse.getPableCount()==2&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL23,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV14":null;
        String EVx39=zse.getPableCount()==2&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL4,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV15":null;
        ...
        String EVx43=zse.getPableCount()>=3&&zse.getIsRlook()&&!zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL34,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV22":null;
        String EVx44=zse.getPableCount()>=3&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL23,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV24":null;
        String EVx45=zse.getPableCount()>=3&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL4,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV25":null;
        String EVx46=zse.getPableCount()>=3&&zse.getIsRlook()&&!zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL34,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV27":null;
        String EVx47=zse.getPableCount()>=3&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL23,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV29":null;
        String EVx48=zse.getPableCount()>=3&&zse.getIsRlook()&&zse.getIsPlook()&&zse.getBetType()==RobotFeaturesEnum.FOLLOW&&RobotFeaturesEnum.isLevel(RobotFeaturesEnum.LEVEL4,zse.getLevel())&&zse.getFeatures()==RobotFeaturesEnum.NORMAL?"EV30":null;
